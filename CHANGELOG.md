...
- Added the new [`dataFileCacheTtl`][configurationParameters] configuration parameter (in minutes, default `90`). It controls how long the data file cached in the browser storage is considered fresh:
...
- Updated dependencies
  - @kameleoon/javascript-sdk-core@5.27.0
...
[getVisitorCode]: https://developers.kameleoon.com/feature-management-and-experimentation/web-sdks/js-sdk#getvisitorcode
...
- Updated dependencies
  - @kameleoon/javascript-sdk-core@5.16.1
